...
CREATE TABLE LABDATABASE.PROFISSIONAIS_RESPONSAVEIS (
    COD_RELACIONAMENTO NUMERIC NOT NULL,
    PROF_LICENCA NUMERIC NOT NULL,
    CPF VARCHAR2(11) NOT NULL,
    CONSTRAINT ID_RESPONSAVEL_PK PRIMARY KEY (COD_RELACIONAMENTO)
);

/*ADD CONSTRAINT FOREIGN KEY*/
ALTER TABLE LABDATABASE.PROFISSIONAIS_RESPONSAVEIS ADD CONSTRAINT PROFISSIONAL_FK
FOREIGN KEY (PROF_LICENCA)
REFERENCES LABDATABASE.INFOS_PROFISSIONAIS (PROF_LICENCA)
NOT DEFERRABLE;

ALTER TABLE LABDATABASE.PROFISSIONAIS_RESPONSAVEIS ADD CONSTRAINT PACIENTE_FK
FOREIGN KEY (CPF)
REFERENCES LABDATABASE.PACIENTE (CPF)
NOT DEFERRABLE;

/*GRANT ACCESS*/
GRANT ALL ON LABDATABASE.PACIENTES TO LABDATABASE;
GRANT ALL ON LABDATABASE.AGENDAMENTOS TO LABDATABASE;
GRANT ALL ON LABDATABASE.PROFISSIONAIS_RESPONSAVEIS TO LABDATABASE;
