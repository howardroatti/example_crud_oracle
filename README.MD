# Sistema em Python fazendo CRUD no Oracle

Esse sistema de exemplo é composto por um conjunto de tabelas que representam pontos de funcionários, contendo tabelas como: pontos e funcionarios.
...
## Organização
- [diagrams](diagrams): Nesse diretório está o [diagrama relacional](diagrams/DIAGRAMA_PONTOS_FUNCIONARIOS.pdf) (lógico) do sistema.
    * O sistema possui duas entidades: PONTOS e FUNCIONARIOS
- [sql](sql): Nesse diretório estão os scripts para criação das tabelas e inserção de dados fictícios para testes do sistema
    ...
    * [create_tables_pontos.sql](sql/create_tables_pontos.sql): script responsável pela criação das tabelas, relacionamentos e criação de permissão no esquema LabDatabase.
...
- [src](src): Nesse diretório estão os scripts do sistema
    ...
    * [model](src/model/): Nesse diretório encontram-ser as classes das entidades descritas no [diagrama relacional](diagrams/DIAGRAMA_PONTOS_FUNCIONARIOS.pdf)
